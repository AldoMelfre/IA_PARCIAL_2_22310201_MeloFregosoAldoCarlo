...
class RedNeuronal:
    ...
    def retropropagacion(self, X, y, activaciones, entradas):
        """
    ...
    def entrenar(self, X, y):
        ...
        for _ in range(self.epochs):
            ...
            gradientes_pesos, gradientes_sesgos = self.retropropagacion(X, y, activaciones, entradas)
...
# ============================================
# EJEMPLO: RETROPROPAGACIÓN DEL ERROR
# ============================================
...
red = RedNeuronal(tamanos=[2, 4, 1], tasa_aprendizaje=0.1, epochs=10000)
red.entrenar(X, y)
