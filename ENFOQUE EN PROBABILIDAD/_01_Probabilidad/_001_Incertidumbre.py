# ============================================
# INCERTIDUMBRE: CÁLCULO DE PROBABILIDADES CON LA REGLA DE BAYES
# ============================================

# DESCRIPCIÓN TEÓRICA:
# En el enfoque de probabilidad, la incertidumbre se maneja utilizando distribuciones de probabilidad.
# La **Regla de Bayes** es una herramienta fundamental para actualizar nuestras creencias sobre un evento
...
# El algoritmo calcula la probabilidad de que el paciente tenga la enfermedad dado un resultado positivo.

# ============================================
# FUNCIÓN PARA CALCULAR LA PROBABILIDAD POSTERIOR
# ============================================
def calcular_probabilidad_posterior(p_hipotesis, p_evidencia_dado_hipotesis, p_evidencia_dado_no_hipotesis):
    """
...
p_posterior = calcular_probabilidad_posterior(p_hipotesis, p_evidencia_dado_hipotesis, p_evidencia_dado_no_hipotesis)
