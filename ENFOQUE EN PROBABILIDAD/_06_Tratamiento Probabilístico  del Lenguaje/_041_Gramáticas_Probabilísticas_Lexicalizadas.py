...
# ============================================
class GramáticaLexicalizada:
    def __init__(self):
        """
        Inicializa la gramática probabilística lexicalizada.
        """
    ...
    def generar(self, simbolo, palabra_lexicalizada=None):
        """
        Genera una oración a partir de un símbolo no terminal.
        :param simbolo: Símbolo no terminal inicial.
        :param palabra_lexicalizada: Palabra específica que influye en la generación.
        ...
        resultado = []
        for s in produccion:
            resultado.extend(self.generar(s, palabra_lexicalizada))
        return resultado

# ============================================
# EJEMPLO: GRAMÁTICA PROBABILÍSTICA LEXICALIZADA
# ============================================
# Crear una gramática probabilística lexicalizada
gramatica = GramáticaLexicalizada()
