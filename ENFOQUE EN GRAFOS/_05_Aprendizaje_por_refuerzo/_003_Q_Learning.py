# ============================================
# Q-LEARNING: APRENDIZAJE POR REFUERZO ACTIVO
# ============================================

# DESCRIPCIÓN TEÓRICA:
# Q-Learning es un algoritmo de aprendizaje por refuerzo que permite a un agente aprender una política óptima
# explorando activamente el entorno. El agente actualiza los valores Q, que representan la calidad de una acción
# en un estado, basándose en las recompensas observadas y las transiciones entre estados.
# 
# COMPONENTES:
